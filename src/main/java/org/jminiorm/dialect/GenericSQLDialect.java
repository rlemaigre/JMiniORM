 ...
 * as needed to provide support for specific databases.
 */
public class GenericSQLDialect implements ISQLDialect {
	...
	/**
	 * Quotes the identifier. Does nothing by default, so that you can leave
	 * identifiers unquoted in your statements as well without having
	 * case-sensistivity problems with some databases.
	 *
	 * @param identifier
	 * @return
	 */
	...
	/**
	 * To avoid SQL injection attacks, the default implementation simply throws an
	 * Exception if there is a special character in the identifier. Only letters,
	 * numbers, dots and underscores are allowed. Override if there is a safe
	 * mechanism to escape special characters in your database and if you need
	 * special characters. You may also keep the current behavior but whitelist some
	 * identifiers.
	 *
	 * @param identifier
	 * @return
